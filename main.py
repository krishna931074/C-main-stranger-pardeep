...
import tempfile
from db import (get_collection, save_name, load_name, save_log_channel_id, 
                load_log_channel_id, save_authorized_users, load_authorized_users, 
                load_allowed_channel_ids, save_allowed_channel_ids, load_accept_logs, 
                save_accept_logs, save_bot_running_time, load_bot_running_time, 
                reset_bot_running_time, save_max_running_time, load_max_running_time, 
...
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://krishna931074:4L2TsfrwBSOu3sxB@cluster0.2p4co.mongodb.net/")
...
async def start(client: Client, msg: Message):
    if msg.from_user is None:
        await msg.reply_text("User information is missing.")
        return
    ...
    if msg.from_user.id in authorized_users:
        ...
        await start_message.edit_text(
            ...
            "I'm here to make your life easier by downloading videos from your **.txt** file 📄 and uploading them directly to"
               )
...
@bot.on_message(filters.command(["miku"]))
